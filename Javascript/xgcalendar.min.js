...
e.startdate;f.enddate=e.enddate>f.enddate?e.enddate:f.enddate;g.loadDateR.splice(d+1,1);h--}else d++}}}function q(){var c=new Date(g.showday.getFullYear(),g.showday.getMonth(),g.showday.getDate()),a=g.eventItems,h={view:g.view,weekstartday:g.weekstartday,theme:g.theme};if(g.view=="day"||g.view=="week"){var d=j("#dvtec");if(d.length>0)g.scoll=d.attr("scrollTop")}switch(g.view){case "day":y(c,1,a,h);break;case "week":y(c,7,a,h);break;case "month":d=[];d.push("<div id='cal-month-cc' class='cc'><div id='cal-month-cc-header'><div class='cc-close' id='cal-month-closebtn'></div><div id='cal-month-cc-title' class='cc-title'></div></div><div id='cal-month-cc-body' class='cc-body'><div id='cal-month-cc-content' class='st-contents'><table class='st-grid' cellSpacing='0' cellPadding='0'><tbody></tbody></table></div></div></div>");
d.push('<div id="mvcontainer" class="mv-container">');d.push('<table id="mvweek" class="mv-daynames-table" cellSpacing="0" cellPadding="0"><tbody><tr>');for(var f=h.weekstartday,e=0;e<7;f++,e++){if(f>6)f=0;d.push('<th class="mv-dayname" title="',Q[f],'">',Q[f],"")}d.push("</tr></tbody></table>");d.push("</div>");f=g.height-21;d.push('<div id="mvEventContainer" class="mv-event-container" style="height:',f,"px;",'">');var i=h.weekstartday;e=f;f=new Date(c.getFullYear(),c.getMonth(),1);var l=i-f.getDay();
h=c.getMonth();if(l>0)l-=7;var m=z("d",l,f),n=z("d",34,m);f=5;if(n.getFullYear()==c.getFullYear()&&n.getMonth()==c.getMonth()&&n.getDate()<wa[h]){n=z("d",7,n);f=6}g.vstart=m;g.vend=n;g.datestrshow=Z(m,n);e-=18*f;e/=f;c=parseInt(e/21);e%21>15&&c++;e=100/f;l=[];for(var k={},p=a.length,u=0;u<p;u++){var o=a[u][2],t=a[u][3],x=A("d",o,t),v={};v.event=a[u];v.day=o.getDate();v.year=o.getFullYear();v.month=o.getMonth()+1;v.allday=a[u][4]==1;v.crossday=a[u][5]==1;v.reevent=a[u][6]==1;v.daystr=v.year+"/"+v.month+
"/"+v.day;v.st={};v.st.hour=o.getHours();v.st.minute=o.getMinutes();v.st.p=v.st.hour*60+v.st.minute;v.et={};v.et.hour=t.getHours();v.et.minute=t.getMinutes();v.et.p=v.et.hour*60+v.et.minute;if(x>0){if(o<m)o=m;if(t>n)t=n;x=i-o.getDay();if(x>0)x-=7;for(x=z("d",x,o);x<=t;o=x=z("d",7,x)){var L=Y(v),G=s.call(o,i18n.xgcalendar.dateformat.fulldaykey),B=A("d",x,t);if(k[G]==null)k[G]=[];L.colSpan=B>=7?7-A("d",x,o):A("d",o,t)+1;k[G].push(L)}}else{G=s.call(a[u][2],i18n.xgcalendar.dateformat.fulldaykey);if(k[G]==
null)k[G]=[];v.colSpan=1;k[G].push(v)}}a=[];i=[];for(n=0;n<f;n++){u=0;l[n]=b=[];for(p=0;p<7;p++){o=z("d",n*7+p,m);i[n*7+p]=o;o=s.call(o,i18n.xgcalendar.dateformat.fulldaykey);b[p]=k[o];if(b[p]&&b[p].length>0)u+=b[p].length}a[n]=u}ha.data("mvdata",l);for(n=0;n<f;n++){d.push("<div id='mvrow_",n,"' style=\"HEIGHT:",e,"%; TOP:",e*n,'%"  class="month-row">');d.push('<table class="st-bg-table" cellSpacing="0" cellPadding="0"><tbody><tr>');u=a[n];for(p=0;p<7;p++){m=i[n*7+p];d.push("<td abbr='",s.call(m,
i18n.xgcalendar.dateformat.fulldayvalue),"' ch='qkadd' axis='00:00' title=''");s.call(m,"yyyyMMdd")==s.call(new Date,"yyyyMMdd")?d.push(' class="st-bg st-bg-today">'):d.push(' class="st-bg">');d.push("&nbsp;</td>")}d.push("</tr></tbody></table>");d.push('<table class="st-grid" cellpadding="0" cellspacing="0"><tbody>');d.push("<tr>");for(p=0;p<7;p++){k={titleClass:"",dayshow:""};m=i[n*7+p];if(s.call(m,"yyyyMMdd")==s.call(new Date,"yyyyMMdd"))k.titleClass=" st-dtitle-today";if(m.getMonth()!=h)k.titleClass=
" st-dtitle-nonmonth";k.title=s.call(m,i18n.xgcalendar.dateformat.fulldayshow);k.dayshow=m.getDate()==1?m.getMonth==0?s.call(m,i18n.xgcalendar.dateformat.fulldayshow):s.call(m,i18n.xgcalendar.dateformat.Md3):m.getDate();k.abbr=s.call(m,i18n.xgcalendar.dateformat.fulldayvalue);d.push(M("<td class=\"st-dtitle${titleClass}\" ch='qkadd' abbr='${abbr}' axis='00:00' title=\"${title}\"><span class='monthdayshow'>${dayshow}</span></a></td>",k))}d.push("</tr>");m=d;k=l[n];p=u;u=c;var D=i[n*7];o=[];t=[];v=
[];x=[];L=k.length;for(B=G=0;B<L;B++){o.push(0);t.push(0);v.push(0);x.push(z("d",B,D))}for(B=0;B<L;B++){var w=k[B]?k[B].length:0;t[B]+=w;for(var E=0;E<w;E++)if((D=k[B][E])&&D.colSpan>1)for(var H=1;H<D.colSpan;H++)t[B+H]++}for(B=0;B<u&&G<p;B++){m.push("<tr>");for(w=0;w<L;){D=k[w]?k[w][o[w]]:undefined;E={"class":"",axis:"",ch:"",title:"",abbr:"",html:"",otherAttr:"",click:"javascript:void(0);"};var $=["st-c"];if(D){o[w]+=1;H=false;if(v[w]+1==t[w]&&D.colSpan==1)H=true;if(!H&&B==u-1&&v[w]<t[w]){G++;j.extend(E,
{axis:w,ch:"more",abbr:s.call(x[w],i18n.xgcalendar.dateformat.fulldayvalue),html:i18n.xgcalendar.others+(t[w]-v[w])+i18n.xgcalendar.item,click:"javascript:alert('more event');"});$.push("st-more st-moreul");w++}else{E.html=ia(D,x[w],L-w);E.ch="show";if(D.colSpan>1){E.otherAttr=" colSpan='"+D.colSpan+"'";for(H=0;H<D.colSpan;H++)v[w+H]+=1;w+=D.colSpan}else{v[w]+=1;w++}G++}}else{if(B==u-1&&v[w]<t[w]&&t[w]>0){j.extend(E,{axis:w,ch:"more",abbr:s.call(x[w],i18n.xgcalendar.dateformat.fulldayvalue),html:i18n.xgcalendar.others+
(t[w]-v[w])+i18n.xgcalendar.item,click:"javascript:alert('more event');"});$.push("st-more st-moreul")}else{j.extend(E,{html:"&nbsp;",ch:"qkadd",axis:"00:00",abbr:s.call(x[w],i18n.xgcalendar.dateformat.fulldayvalue),title:""});$.push("st-s")}w++}E.cssclass=$.join(" ");m.push(M("<td class='${cssclass}' axis='${axis}' ch='${ch}' abbr='${abbr}' title='${title}' ${otherAttr}>${html}</td>",E))}m.push("</tr>")}d.push("</tbody></table>");d.push("</div>")}d.push("</div>");I.html(d.join(""));j("#cal-month-closebtn").click(J);
break;default:alert(i18n.xgcalendar.no_implement)}xa(g.view);d=g.view;if(d=="day"||d=="week"){h=j("#dvwkcontaienr");d=j("#dvtec");if(h.length==0||d.length==0)alert(i18n.xgcalendar.view_no_ready);else{h=h.height()+2;d.height(g.height-8-h);if(typeof g.scoll=="undefined"){f=new Date;h=f.getHours();f=f.getMinutes();c=K(h,f);f=d.attr("clientHeight");c-=0.5*f;e=d.attr("scrollHeight");if(c<0)c=0;if(c>e-f)c=e-f-10*(23-h);d.attr("scrollTop",c)}else d.attr("scrollTop",g.scoll)}}}function y(c,a,h,d){var f=[];
if(a==1){d=s.call(c,i18n.xgcalendar.dateformat.Md);f.push({display:d,date:c,day:c.getDate(),year:c.getFullYear(),month:c.getMonth()+1});g.datestrshow=Z(f[0].date);g.vstart=f[0].date;g.vend=f[0].date}else{var e=0;if(a==7){e=d.weekstartday-c.getDay();if(e>0)e-=7}for(var i=e,l=0;l<a;i+=1,l++){e=z("d",i,c);d=s.call(e,i18n.xgcalendar.dateformat.Md);f.push({display:d,date:e,day:e.getDate(),year:e.getFullYear(),month:e.getMonth()+1})}g.vstart=f[0].date;g.vend=f[a-1].date;g.datestrshow=Z(f[0].date,f[a-1].date)}a=
[];c=[];d=f.length;i=h.length;l=[];for(e=0;e<i;e++){var m=h[e][2],n=h[e][3],k={};k.event=h[e];k.day=m.getDate();k.year=m.getFullYear();k.month=m.getMonth()+1;k.allday=h[e][4]==1;k.crossday=h[e][5]==1;k.reevent=h[e][6]==1;k.daystr=[k.year,k.month,k.day].join("/");k.st={};k.st.hour=m.getHours();k.st.minute=m.getMinutes();k.st.p=k.st.hour*60+k.st.minute;k.et={};k.et.hour=n.getHours();k.et.minute=n.getMinutes();k.et.p=k.et.hour*60+k.et.minute;l.push(k)}for(i=h=0;i<d;i++){m=f[i];c[i]=[];a[i]=[];m.daystr=
m.year+"/"+m.month+"/"+m.day;for(e=0;e<l.length;e++)if(!l[e].crossday&&!l[e].allday)m.daystr==l[e].daystr&&c[i].push(l[e]);else if(m.daystr==l[e].daystr){a[i].push(l[e]);h++}else if(i==0&&m.date>=l[e].event[2]&&m.date<=l[e].event[3]){a[i].push(l[e]);h++}}l=f[d-1].date;for(i=0;i<d;i++){k=a[i];if(k.length>0)for(e=0;e<k.length;e++){m=A("d",l,k[e].event[3])>0?l:k[e].event[3];k[e].colSpan=A("d",f[i].date,m)+1}}for(i=0;i<d;i++){k=c[i];if(k.length>0){l=[];m=[];var p=[],u=k.length,o;for(e=0;e<u;++e){var t=
k[e],x=t.st.p;for(o=0;m[o]>x;)o++;t.PO=o;t.ne=[];m[o]=t.et.p||1440;l[o]=t;p[o]||(p[o]=[]);p[o].push(t);if(o!=0){t.pe=[l[o-1]];l[o-1].ne.push(t)}for(o+=1;m[o]<=x;)o++;if(l[o]){n=l[o];t.ne.push(n);n.pe.push(t)}t.width=1/(t.PO+1);t.left=1-t.width}n=Array.prototype.concat.apply([],p);for(m=e=n.length;m--;){k=1;x=0;l=n[m];for(p=l.ne.length;p--;){o=l.ne[p];x=Math.max(x,o.VL);k=Math.min(k,o.left)}l.VL=x+1;l.width=k/(l.PO+1);l.left=k-l.width}for(m=0;m<e;m++){l=n[m];l.left=0;if(l.pe)for(p=l.pe.length;p--;){k=
l.pe[p];l.left=Math.max(l.left,k.left+k.width)}k=(1-l.left)/l.VL;l.width=Math.max(l.width,k);l.aQ=Math.min(1-l.left,l.width+0.7*k)}c[i]=n}}e=h;d=[];d.push('<div id="dvwkcontaienr" class="wktopcontainer">');d.push('<table class="wk-top" border="0" cellpadding="0" cellspacing="0">');d.push("<tr>",'<th width="60" rowspan="3">&nbsp;</th>');for(h=0;h<f.length;h++){if(f.length==1)m=l=i="";else{i="";l=i18n.xgcalendar.to_date_view;m="wk-daylink"}d.push("<th abbr='",s.call(f[h].date,i18n.xgcalendar.dateformat.fulldayvalue),
"' class='gcweekname' scope=\"col\"><div title='",l,"' ",i," class='wk-dayname'><span class='",m,"'>",f[h].display,"</span></div></th>")}d.push('<th width="16" rowspan="3">&nbsp;</th>');d.push("</tr>");d.push("<tr>");d.push('<td class="wk-allday"');f.length>1&&d.push(" colSpan='",f.length,"'");d.push('><div id="weekViewAllDaywk" ><table class="st-grid" cellpadding="0" cellspacing="0"><tbody>');if(e==0){d.push("<tr>");for(h=0;h<f.length;h++)d.push('<td class="st-c st-s"'," ch='qkadd' abbr='",s.call(f[h].date,
"yyyy-M-d"),"' axis='00:00'>&nbsp;</td>")}else{h=a.length;i=0;l=[];for(m=0;m<h;m++)l.push(0);for(m=0;i<e;m++){d.push("<tr>");for(n=0;n<h;){k=a[n][l[n]];d.push("<td class='st-c");if(k){l[n]+=1;d.push("'");p=ia(k,f[n].date,h-n);if(k.colSpan>1){d.push(" colSpan='",k.colSpan,"'");n+=k.colSpan}else n++;d.push(" ch='show'>",p);i++}else{d.push(" st-s' ch='qkadd' abbr='",s.call(f[n].date,i18n.xgcalendar.dateformat.fulldayvalue),"' axis='00:00'>&nbsp;");n++}d.push("</td>")}d.push("</tr>")}d.push("<tr>");for(n=
0;n<h;n++)d.push("<td class='st-c st-s' ch='qkadd' abbr='",s.call(f[n].date,i18n.xgcalendar.dateformat.fulldayvalue),"' axis='00:00'>&nbsp;</td>")}d.push("</tr>");d.push("</tbody></table></div></td></tr>");d.push("<tr>");d.push('<td style="height: 5px;"');f.length>1&&d.push(" colSpan='",f.length,"'");d.push("></td>");d.push("</tr>");d.push("</table>");d.push("</div>");d.push('<div id="dvtec"  class="scolltimeevent"><table style="table-layout: fixed;',jQuery.browser.msie?"":"width:100%",'" cellspacing="0" cellpadding="0"><tbody><tr><td>');
d.push('<table style="height: 1008px" id="tgTable" class="tg-timedevents" cellspacing="0" cellpadding="0"><tbody>');d.push("<tr>");d.push("<td style='width:60px;'></td>");d.push("<td");f.length>1&&d.push(" colSpan='",f.length,"'");d.push('><div id="tgspanningwrapper" class="tg-spanningwrapper"><div style="font-size: 20px" class="tg-hourmarkers">');for(a=0;a<24;a++)d.push('<div class="tg-dualmarker"></div>');d.push("</div></div></td></tr>");d.push("<tr>");d.push('<td style="width: 60px" class="tg-times">');
e=new Date;a=e.getHours();e=e.getMinutes();e=K(a,e)-4;d.push('<div id="tgnowptr" class="tg-nowptr" style="left:0px;top:',e,'px"></div>');h="";for(a=0;a<24;a++){h=aa(a,0,g.tgtimeFormat);d.push('<div style="height: 41px" class="tg-time">',h,"</div>")}d.push("</td>");h=f.length;for(a=0;a<h;a++){d.push("<td class=\"tg-col\" ch='qkadd' abbr='",s.call(f[a].date,i18n.xgcalendar.dateformat.fulldayvalue),"'>");(i=s.call(f[a].date,"yyyyMMdd")==s.call(new Date,"yyyyMMdd"))&&d.push('<div style="margin-bottom: -1008px; height:1008px" class="tg-today">&nbsp;</div>');
d.push('<div  style="margin-bottom: -1008px; height: 1008px" id=\'tgCol',a,'\' class="tg-col-eventwrapper">');l=d;m=c[a];for(n=0;n<m.length;n++){o=m[n].event[7]&&m[n].event[7]>=0?R(m[n].event[7]):R();k=m[n];p=n;o={bdcolor:o[0],bgcolor2:o[0],bgcolor1:o[2],width:"70%",icon:"",title:"",data:""};o.starttime=aa(k.st.hour,k.st.minute,g.timeFormat);o.endtime=aa(k.et.hour,k.et.minute,g.timeFormat);o.content=k.event[1];o.title=C(k.event);o.data=k.event.join("$");x=[];x.push('<I class="cic cic-tmr">&nbsp;</I>');
k.reevent&&x.push('<I class="cic cic-spcl">&nbsp;</I>');o.icon=x.join("");x=K(k.st.hour,k.st.minute);u=K(k.et.hour,k.et.minute);o.top=x+"px";o.left=k.left*100+"%";o.width=k.aQ*100+"%";o.height=u-x-4;o.i=p;if(g.enableDrag&&k.event[8]==1){o.drag="drag";o.redisplay="block"}else{o.drag="";o.redisplay="none"}k=M(na,o);l.push(k)}d.push("</div>");d.push('<div class="tg-col-overlaywrapper" id=\'tgOver',a,"'>");i&&d.push('<div id="tgnowmarker" class="tg-hourmarker tg-nowmarker" style="left:0px;top:',e+4,'px"></div>');
d.push("</div>");d.push("</td>")}d.push("</tr>");d.push("</tbody></table></td></tr></tbody></table></div>");I.html(d.join(""))}function J(){j("#cal-month-cc").css("visibility","hidden")}function C(c){var a,h,d,f;h=c[4]!=1;f=c[1];a=T(c[2],null,h,true);h=T(c[3],c[2],h,true);a=s.call(c[2],a)+" - "+s.call(c[3],h);h=c[9]!=undefined&&c[9]!=""?c[9]:i18n.xgcalendar.i_undefined;d=c[10]!=undefined&&c[10]!=""?c[10]:"";var e=[];if(c[4]==1)e.push("["+i18n.xgcalendar.allday_event+"]",j.browser.mozilla?"":"\r\n");
else if(c[5]==1)e.push("["+i18n.xgcalendar.repeat_event+"]",j.browser.mozilla?"":"\r\n");e.push(i18n.xgcalendar.time+":",a,j.browser.mozilla?"":"\r\n",i18n.xgcalendar.event+":",f,j.browser.mozilla?"":"\r\n",i18n.xgcalendar.location+":",h);if(d!="")e.push(j.browser.mozilla?"":"\r\n",i18n.xgcalendar.participant+":",d);return e.join("")}function ia(c,a,h){var d={color:(c.event[7]&&c.event[7]>=0?R(c.event[7]):R())[2],title:"",extendClass:"",extendHTML:"",data:""};d.title=C(c.event);d.id="bbit_cal_event_"+
c.event[0];d.eclass=g.enableDrag&&c.event[8]==1?"drag":"cal_"+c.event[0];d.data=c.event.join("$");var f=[],e=c.event[2]<a;a=A("d",a,c.event[3])>=h;if(e||a){if(e){f.push('<div class="st-ad-ml"></div>');d.extendClass="st-ad-mpad "}a&&f.push('<div class="st-ad-mr"></div>');d.extendHTML=f.join("")}f=!c.allday&&!e?aa(c.st.hour,c.st.minute,g.timeFormat)+" "+c.event[1]:c.event[1];e=[];e.push(M('<span style="cursor: pointer">${content}</span>',{content:f}));e.push('<I class="cic cic-tmr">&nbsp;</I>');c.reevent&&
e.push('<I class="cic cic-rcr">&nbsp;</I>');d.content=e.join("");return M(ya,d)}function ja(){if(g.isloading)return true;if(g.url&&g.url!=""){g.isloading=true;if(g.onBeforeRequestData&&j.isFunction(g.onBeforeRequestData))g.onBeforeRequestData(1);var c=(new Date).getTimezoneOffset()/60*-1;c=[{name:"showdate",value:s.call(g.showday,i18n.xgcalendar.dateformat.fulldayvalue)},{name:"viewtype",value:g.view},{name:"timezone",value:c}];if(g.extParam)for(var a=0;a<g.extParam.length;a++)c[c.length]=g.extParam[a];
j.ajax({type:g.method,url:g.url,data:c,dataType:"json",dataFilter:function(h){return h.replace(/"\\\/(Date\([0-9-]+\))\\\/"/gi,"new $1")},success:function(h){if(h!=null&&h.error!=null){if(g.onRequestDataError)g.onRequestDataError(1,h)}else{za(h,h.start,h.end);r(h.start,h.end)}if(g.onAfterRequestData&&j.isFunction(g.onAfterRequestData))g.onAfterRequestData(1);g.isloading=false},error:function(h){try{if(g.onRequestDataError)g.onRequestDataError(1,h);else alert(i18n.xgcalendar.get_data_exception);if(g.onAfterRequestData&&
j.isFunction(g.onAfterRequestData))g.onAfterRequestData(1);g.isloading=false}catch(d){}}})}else alert("url"+i18n.xgcalendar.i_undefined)}function za(c,a,h){c=c.issort==false?c.events&&c.events.length>0?c.sort(function(d,f){return d[2]>f[2]?-1:1}):[]:c.events;Aa(c,a,h);q()}function Aa(c,a,h){c||(c=[]);if(c)if(g.eventItems.length==0)g.eventItems=c;else{var d=c,f=d.length;if(f>0)for(var e=d[0][2],i=d[f-1][2],l=0,m=g.eventItems.length;l<m;l++){if(g.eventItems[l][2]>i||f==0)break;if(g.eventItems[l][2]>=
e)for(var n=0;n<f;n++)if(g.eventItems[l][0]==d[n][0]&&g.eventItems[l][2]<a){d.splice(n,1);f--;break}}d=g.eventItems.length;e=-1;f=d;if(g.eventItems[0][2]>h)g.eventItems=c.concat(g.eventItems);else if(g.eventItems[d-1][2]<a)g.eventItems=g.eventItems.concat(c);else{for(i=0;i<d;i++)if(g.eventItems[i][2]>=a&&e<0)e=i;else if(g.eventItems[i][2]>h){f=i;break}a=e<=0?[]:g.eventItems.slice(0,e);h=f==d?[]:g.eventItems.slice(f);g.eventItems=[].concat(a,c,h)}}}function oa(){var c=j(this).attr("abbr");g.showday=
U(c+" 00:00");g.view="day";q();if(g.onWeekOrMonthToDay)g.onWeekOrMonthToDay(g);return false}function K(c,a){return c*42+parseInt(a/60*42)}function ba(c,a){var h=c/42,d=parseInt(h);h=h-d>=0.5?30:0;var f=a/42,e=parseInt(f);return{sh:d,sm:h,eh:e,em:f-e>=0.5?30:0,h:a-c}}function pa(c,a,h){var d=Math.min(c,a);c=Math.max(c,a);var f=(d-h)/42;a=parseInt(f);f=f-a>=0.5?30:0;h=(c-h)/42;var e=parseInt(h);return{sh:a,sm:f,eh:e,em:h-e>=0.5?30:0,h:c-d}}function ca(c){return c<10?"0"+c:""+c}function R(c){function a(h,
d){return"#"+"".substring(h*
...
d.data("cdata",a);d.css({visibility:"visible",left:h.left,top:h.top});j(document).one("click",function(){j("#bbit-cs-buddle").css("visibility","hidden")})}else if(g.ViewCmdhandler)g.ViewCmdhandler&&j.isFunction(g.ViewCmdhandler)&&g.ViewCmdhandler.call(this,a);else alert("ViewCmdhandler"+i18n.xgcalendar.i_undefined);else alert(i18n.xgcalendar.data_format_error);return false}function Ba(c){var a=j(this),h=c.id.split("_")[1],d=j(c);c=a.position();var f=d.position();d=(a.width()+2)*1.5;f=f.top+15;var e=
...
m.find("div.rb-o").each(function(){j(this).click(fa)});n=h=null;l=i.height();m=document.documentElement.clientHeight;if(e+d>=document.documentElement.clientWidth)e=c.left-(a.width()+2)*0.5;if(f+l>=m)f=m-l-2;i.css({left:e,top:f,"z-index":180,width:d,visibility:"visible"});j(document).one("click",J);return false}function la(c,a,h){if(g.quickUpdateUrl!=""&&c[8]==1&&g.readonly!=true){if(g.isloading)return false;g.isloading=true;var d=c[0],f=c[2],e=c[3];c=(new Date).getTimezoneOffset()/60*-1;c=[{name:"calendarId",
value:d},{name:"CalendarStartTime",value:s.call(a,i18n.xgcalendar.dateformat.fulldayvalue+" HH:mm")},{name:"CalendarEndTime",value:s.call(h,i18n.xgcalendar.dateformat.fulldayvalue+" HH:mm")},{name:"timezone",value:c}];var i;if(g.quickUpdateHandler&&j.isFunction(g.quickUpdateHandler))g.quickUpdateHandler.call(this,c);else{g.onBeforeRequestData&&g.onBeforeRequestData(4);j.post(g.quickUpdateUrl,c,function(l){if(l){if(l.IsSuccess==true)g.isloading=false;else{g.onRequestDataError&&g.onRequestDataError(4,
l);g.isloading=false;i=ka(d,true);i[2]=f;i[3]=e;ea(i);q();i=null}g.onAfterRequestData&&g.onAfterRequestData(4)}},"json");if(i=ka(d,true)){i[2]=a;i[3]=h}ea(i);q()}}}function sa(c,a,h,d){if(!(!g.quickAddHandler&&g.quickAddUrl==""||g.readonly)){var f=j("#bbit-cal-buddle");if(f.length==0){f=[];f.push('<div id="bbit-cal-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble">');f.push('<table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div>');
...
a){var h=0;if(a)h=1;else if(g.eventItems&&g.eventItems.length>0){var d=g.eventItems.length,f=c[2],e=f.getTime()-g.eventItems[0][2].getTime(),i=g.eventItems[d-1][2].getTime()-f.getTime();if(e<0||e-i<0)for(e=0;e<d;e++){if(g.eventItems[e][2]>=f){a=e;break}}else if(i<0)a=d;else for(e=d-1;e>=0;e--)if(g.eventItems[e][2]<f){a=e+1;break}}else a=0;if(g.eventItems&&g.eventItems.length>0)a==g.eventItems.length?g.eventItems.push(c):g.eventItems.splice(a,h,c);else g.eventItems=[c];return a}function ma(){return false}
function xa(c){if(c=="week"||c=="day"){j("div.chip",I).each(function(){var a=j(this);a.click(fa);if(a.hasClass("drag")){a.mousedown(function(h){O.call(this,"dw3",h);return false});a.find("div.resizer").mousedown(function(h){O.call(j(this).parent().parent(),"dw4",h);return false})}else a.mousedown(ma)});j("div.rb-o",I).each(function(){var a=j(this);a.click(fa);a.hasClass("drag")&&c=="week"?a.mousedown(function(h){O.call(this,"dw5",h);return false}):a.mousedown(ma)});if(g.readonly==false){j("td.tg-col",
I).each(function(){j(this).mousedown(function(a){O.call(this,"dw1",a);return false})});j("#weekViewAllDaywk").mousedown(function(a){O.call(this,"dw2",a);return false})}c=="week"&&j("#dvwkcontaienr th.gcweekname").each(function(){j(this).click(oa)})}else{c="month";j("div.rb-o",I).each(function(){var a=j(this);a.click(fa);a.hasClass("drag")?a.mousedown(function(h){O.call(this,"m2",h);return false}):a.mousedown(ma)});j("td.st-more",I).each(function(){j(this).click(function(){Ba.call(this,j(this).parent().parent().parent().parent()[0]);
